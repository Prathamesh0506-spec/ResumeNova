...
export default function Navbar() {
    ...
    return (
        <nav class="navbar navbar-expand-lg navbar-dark px-4 shadow sticky-top" style={{ backgroundColor: "#064051" }}>
            <div class="container-fluid">
                
                {/* BRANDING / LOGO */}
                <Link class="navbar-brand fw-bold text-uppercase" to="/">
                    <span style={{ color: "#1E9C99" }}>Resume</span>Nova
                </Link>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="resumeNavbar">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <Link to="/Get-plus" class="nav-link fw-bold mx-2" style={{ color: "#81DBDB" }}>Get+</Link>
                        </li>
                    </ul>
                    ...
                    <div class="d-flex align-items-center">
                        <button 
                            ...
                            style={{ borderColor: "#48C8C5", color: "#48C8C5", backgroundColor: "transparent" }}
